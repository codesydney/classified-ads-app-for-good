...
const Developers = () => {
  ...
  return (
    <div>
      <h1 className="text-4xl text-bold text-primary text-center mb-5 md:text-5xl">Code.Sydney Developers</h1>
          ...
          <div className="flex">
            ...
            <div className="flex-auto w-2/3">
              ...
              {dev.skills.map((skill) => (
                <div className="px-4 py-2 font-semibold text-sm bg-cyan-500 text-white rounded-full shadow-sm">{skill}</div>
              ))}
              <div>{dev.blurb}</div>
            </div>
          </div>
